                  ...
                  <div class="col-lg-4 col-sm-6">
                    <div class="product text-center">
                      <div class="mb-3 position-relative">
                        <div class="badge text-white badge-"></div><a class="d-block" href="detail.php"><img class="img-fluid w-100" src="admin/images/<?= $product['image'] ?>" alt="..."></a>
                      ...
                      <h6> <a class="reset-anchor" href="detail.php?id=<?=$product['id'] ?>">
                        <?= $product['name'] ?>
                      </a></h6>
