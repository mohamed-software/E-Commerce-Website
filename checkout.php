              ...
              <form class="leave-comment">
                <div class="row">
                  <div class="col-lg-6 form-group">
                    <label class="text-small text-uppercase" for="name">Full Name</label>
                    <input class="form-control form-control-lg" id="name" type="text" placeholder="Enter your full name">
                  </div>
                  <!-- <div class="col-lg-6 form-group">
                  ...
                  <div class="col-lg-6 form-group">
                    ...
                    <input class="form-control form-control-lg" id="email" type="email" placeholder="mido111800@yahoo.com">
                  </div>
                  <div class="col-lg-12 form-group">
                    <label class="text-small text-uppercase" for="phone">Phone number </label>
                    <input class="form-control form-control-lg" id="phone" type="text" placeholder="e.g. +02 245354745">
                  </div>
                  <!-- <div class="col-lg-6 form-group">
                    <label class="text-small text-uppercase" for="phone">Phone number</label>
                  ...
                  <div class="col-lg-6 form-group">
                    <label class="text-small text-uppercase" for="massage">massage</label>
                    <input class="form-control form-control-lg" id ="massage" type="text">
                  </div>
                  <div class="col-lg-6 form-group">
