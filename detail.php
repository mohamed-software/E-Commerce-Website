...
<html>
  <head>
    ...
    <title> E commerce mohamed salah</title>
  ...
  <body>
    <div class="page-holder bg-light">
      ...
      <?php
          ...
          $selPRO = "SELECT * FROM products WHERE id = '$pro_id'";
              ...
              <div class="row m-sm-0">
                <div class="col-sm-2 p-sm-0 order-2 order-sm-1 mt-2 mt-sm-0">
                  <div class="owl-thumbs d-flex flex-row flex-sm-column" data-slider-id="1">
                    ...
                    <div class="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0"><img class="w-100" src="admin/images/<?=$product['image'] ?>" alt="..."></div>
                    <div class="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0"><img class="w-100" src="admin/images/<?=$product['image'] ?>" alt="..."></div>
                    <div class="owl-thumb-item flex-fill mb-2"><img class="w-100" src="admin/images/<?=$product['image'] ?>" alt="..."></div>
                  </div>
                </div>
                <div class="col-sm-10 order-1 order-sm-2">
                  <div class="owl-carousel product-slider" data-slider-id="1">
                    <a class="d-block" href="admin/images/<?=$product['image'] ?>" data-lightbox="product" title="Product item 1">
                      <img class="img-fluid" src="admin/images/<?=$product['image'] ?>" alt="...">
                    </a>
                    <a class="d-block" href="admin/images/<?=$product['image'] ?>" data-lightbox="product" title="Product item 2">
                      <img class="img-fluid" src="admin/images/<?=$product['image'] ?>" alt="...">
                    </a>
                    <a class="d-block" href="admin/images/<?=$product['image'] ?>" data-lightbox="product" title="Product item 3">
                      <img class="img-fluid" src="admin/images/<?=$product['image'] ?>" alt="...">
                    </a>
                    <a class="d-block" href="admin/images/<?=$product['image'] ?>" data-lightbox="product" title="Product item 4">
                      <img class="img-fluid" src="admin/images/<?=$product['image'] ?>" alt="...">
                    </a>
                  </div>
                </div>
